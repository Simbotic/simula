...
/// ```
///
/// Some options can be changed by inserting your own `Lines` resource:
///
/// ```
/// use bevy::prelude::*;
/// use bevy_prototype_debug_lines::*;
...
///     .add_plugins(DefaultPlugins)
///     .add_plugin(LinesPlugin)
///     .insert_resource(Lines { depth_test: true, ..Default::default() })
///     ...
///     .run();
/// }
/// ```
...
fn setup(
    ...
    let mut p = PipelineDescriptor::default_config(ShaderStages {
        vertex: shaders.add(Shader::from_glsl(
            ShaderStage::Vertex,
            include_str!("../../assets/shaders/line.vert"),
        )),
        fragment: Some(shaders.add(Shader::from_glsl(
            ShaderStage::Fragment,
            include_str!("../../assets/shaders/line.frag"),
        ))),
    });
